...
def model_train(loader_train,loader_test):
    ...
    optimizer = torch.optim.Adam(msresnet.parameters(), lr=0.01,weight_decay= 0.5,amsgrad= True)
    ...
    for epoch in range(EPOCH):
            ...
            if train_accuracy >= 50  :
                big_profit = profit
                torch.save(msresnet,"BTC_ETH.pkl")
...
if __name__=='__main__':
    ...
    if choose == 0 :
        ...
        test_hole_year.test_reward(120)
