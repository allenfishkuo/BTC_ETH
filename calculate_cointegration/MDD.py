...
path_to_profit = f"/Users/kuoweilun/CryptoCurrency_PT-main/profit_00001/formation_0/"
picture_title ='Pairs trading with CryptoCurrency_tmp'
def plot_performance_with_dd(path_to_profit, ans,total_with_capital,per_reward, dates, open_number,normal_close_number, win_rate,max_cap ):
    ...
    plt.show()
    plt.close()
    return sharp_ratio, per_sharpe_ratio, min(dd)
